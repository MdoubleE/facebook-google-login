...
<?php
 ...
 if(isset($accessToken)){
    ...
    if ($conn->connect_error) {
            ...
            $sql = "SELECT * FROM fb_login WHERE id_user = ".$fb_id."";
            $result = $conn->query($sql);

            if ($result -> num_rows == 0){
                $sql_insert = "INSERT INTO fb_login(`id_user`, `first_name`, `last_name`, `email`, `link`, `gender`, `locale`, `fb_createtime`) VALUES ('".$fb_id."', '".$fb_fname."', '".$fb_lname."', '".$fb_email."', '".$fb_link."', '".$fb_gender."', '".$fb_local."',Now())";
    ...
    echo '<a href="'.$fbloginUrl.'" class="btn-login">Login with Facebook</a>';
